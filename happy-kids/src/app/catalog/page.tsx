  ...
  return (
    <main className={`${styles.container} ${styles.section}`}>
      ...
      <div className={styles.catalogLayout}>
        <aside>
          <form className={styles.filters} method="get" action="/catalog" aria-label="filters">
            <fieldset className={styles.filterGroup}>
              <legend><Loc ru="Сортировка" en="Sorting" /></legend>
              <select name="sort" defaultValue={f.sort} className={styles.sortSelect} aria-label="sort">
                {sortOptions.map((o) => (
